#include <iostream>
#include <stdlib.h>//malloc ve free fonksiyonlarý için eklendi 
using namespace std;
struct dugum
{
	string numara;
...
class TekYonluBagliListe
{
	public:
		...
		void listele() //listeyi yazdýrýyor
		{
			dugum *p;
			p=ilk;
			if(p==NULL) cout<<"Liste boþ"<<endl;
			while(p!=NULL)
			{
				cout<<"*******************"<<endl;
